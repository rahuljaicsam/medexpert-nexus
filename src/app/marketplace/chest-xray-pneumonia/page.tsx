...
const dataset = {
  ...
  validationSplit: "80/10/10",
  lastUpdated: "2024-03-15",
  documentation: {
    overview: `This dataset contains high-quality chest X-ray images annotated by board-certified radiologists for pneumonia detection. Each image is labeled with detailed annotations including:
...
The dataset is balanced across different pneumonia types and includes normal cases for comprehensive model training.`,
    dataFormat: `Images are provided in both DICOM and PNG formats:
- DICOM: Full metadata preserved
- PNG: 1024x1024 resolution, 8-bit grayscale
- JSON: Annotation files with bounding boxes and labels

Annotations follow the COCO format for easy integration with common ML frameworks.`,
    quality: `Quality assurance measures:
- Expert validation by 3+ radiologists
- Inter-annotator agreement > 0.92
- Detailed quality metrics per image
...
def load_dataset(data_path):
  ...
  sampleImages: ["https://images.unsplash.com/photo-1576091160550-2173dba999ef", "https://picsum.photos/200", "https://images.unsplash.com/photo-1530026405186-ed1f139313f8"]
};
